...
from utils import get_next_smoking_time, localize_time
...
LACK_OF_DATA = (
    'Недостаточно данных. '
    'Зафиксируй время выкуренной сигареты 🚬 хотя бы два раза.'
)
RECOMMENDED_TIME = (
...
async def main() -> None:
    if not TOKEN:
        raise UnboundLocalError('No Telegram token provided.')
